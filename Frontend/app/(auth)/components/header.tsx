...
return (
<Link href={href} className={`px-3 py-2 rounded-md ${active ? 'bg-neutral-100' : 'hover:bg-neutral-100'}`}>{children}</Link>
)
}
...
{me ? (
<>
<span className="text-sm text-neutral-600">Hi, {me.displayName ?? me.email}</span>
